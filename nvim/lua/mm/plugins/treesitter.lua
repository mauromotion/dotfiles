...
require('nvim-treesitter.con***REMOVED***gs').setup {
  ...
  ensure_installed = { 'regex', 'markdown_inline', 'query', 'tsx', 'go', 'lua', 'python', 'rust', 'typescript', 'help', 'vim', 'html', 'css', 'javascript', '***REMOVED***sh', 'bash', 'markdown', 'json', 'scss', 'yaml' ***REMOVED***,
