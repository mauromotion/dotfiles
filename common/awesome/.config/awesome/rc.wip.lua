...
-- {{{ Key bindings
local keybindings_module = require("bindings")

-- Function to set keybindings based on layout
-- local function set_keybindings(layout)
-- 	keybindings_module.load_keybindings(layout)

-- 	-- Set global keybindings
-- 	root.keys(awful.util.table.join(root.keys(), unpack(keybindings_module.keybindings.global)))

-- 	-- Set global mouse bindings
-- 	root.buttons(awful.util.table.join(root.buttons(), unpack(keybindings_module.keybindings.global_mouse)))

-- 	-- Connect client keybindings
-- 	client.connect_signal("request::default_keybindings", function()
-- 		awful.keyboard.append_client_keybindings(keybindings_module.keybindings.client)
-- 	end)

-- 	-- Connect client mouse bindings
-- 	client.connect_signal("request::default_mousebindings", function()
-- 		awful.mouse.append_client_mousebindings(keybindings_module.keybindings.client_mouse)
-- 	end)
-- end
get_hostname(function(hostname)
	if hostname == "eva-01" then
		keybindings_module.load_keybindings("colemak-dh")
		-- set_keybindings("colemak-dh")
	else
		-- set_keybindings("qwerty")
		keybindings_module.load_keybindings("qwerty")
	end
end)
-- }}}
